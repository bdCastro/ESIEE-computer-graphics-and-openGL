...
int main()
{
    ...
    // ------------------------------------
    Shader myShader("shaders/triangleShader.vs", "shaders/triangleShader.fs"); // you can name your shader files however you like
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        myShader.setVec4("mColor", 0.0f, greenValue, 0.0f, 1.0f);
